...
delegate void PropertyChangedEventHandler(object sender, PropertyChangedEventArgs ea);
...
void RawPropertyChangedHandler(object sender, PropertyChangedEventArgs ea)
{
    ea.Dump();
}

void FormattedPropertyChangedHandler(object sender, PropertyChangedEventArgs ea)
{
    String
        .Format(
...
void Main()
{
    ...
    me.PropertyChanged += RawPropertyChangedHandler;
    //me.PropertyChanged += FormattedPropertyChangedHandler;
